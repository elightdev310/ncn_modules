...
<tr>
	...
	<td class="col-pp"><div><?php echo $data['pp']; ?></div></td>
	<td class="col-cdv"><div><?php echo $data['claim_docs_in_vos']; ?></div></td>
	
	<td class="col-rcd"><div><?php echo $data['rejected_claim_docs']; ?></div></td>
	<td class="col-adr"><div><?php echo $data['all_docs_reieved']; ?></div></td>
	...
	<td class="col-ce-end"><div><?php echo $data['ce_timer_end']; ?></div></td>
	...
	<td class="col-total-amount"><div><?php echo $data['claim_amount']; ?></div></td>
	<td class="col-coi"><div><?php echo $data['rejected_invoice']; ?></div></td>
