...
<div class="claim-aci-poi-panel">
    <div class="form-group">
        <div for="poi_insured_name" class="col-sm-5 control-label">Insured's Name: </div>
        <div class="col-sm-7">
    ...
    <div class="form-group">
        <div for="poi_insured_address" class="col-sm-5 control-label">Property Address: </div>
        <div class="col-sm-7">
    ...
    <div class="form-group">
        <div for="poi_apt_bldg" class="col-sm-5 control-label">Apt/Bldg: </div>
        <div class="col-sm-7">
    ...
    <div class="form-group">
        <div for="poi_insured_city" class="col-sm-5 control-label">Zip Code: </div>
        <div class="col-sm-7">
