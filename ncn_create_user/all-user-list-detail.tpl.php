...
'profile_memberid'=> array('title'=>t('Member ID#'),'value'=>$_user->profile_memberid),
...
if (ncn_change_order_is_available_to_use_credit($_user->profile_memberid)) {
...
'profile_question_service'		=> array('title'=>t('What kind of restoration services do you provide'),'value'=>trim($_user->profile_question_service, ",")),
);
?>
        ...
        <div class="clearfix">
            <form method="POST" class="user-detail-profile-action">
                ...
                <table>
                    <tr>
                        <td>
                            <?php if (is_member($_user->profile_memberid)): ?>
...
<?php if ( is_member($_user->profile_memberid)|| is_subuser($_user) ): ?>
