        ...
        <form method="POST" id="update_user_role">
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td><?php
                        $role = ncn_admin_render_select_role('user_role', $select_role, '');
                        //  var_dump($select_role);
                        ?>
                        <select name="user_role">
                            ...
                            {
                                ?>
                                <option value="<?php echo $key; ?>" <?php if($key == $select_role) { echo "selected"; }?>><?php echo $value; ?></option>
                            <?php
                            }
                            ?>
                        </select>
